...
docker build -f "${PROJECT_ROOT}/deployments/docker/Dockerfile" -t ${IMAGE_NAME}:${UNIQUE_TAG} "${PROJECT_ROOT}"
...
echo "✅ Successfully pushed ${IMAGE_NAME}:${UNIQUE_TAG} and ${IMAGE_NAME}:${LATEST_TAG} to Docker Hub!"
